...
public class FireStoreService {
    ...
    public ListenerRegistration snapshotOnDocument(String collection, String document, EventListener<DocumentSnapshot> listener){
        return fireStore.collection(collection)
                .document(document)
    ...
    public ListenerRegistration getRecentSupporters(int limit, EventListener<QuerySnapshot> listener){
        return fireStore.collection("supporters")
                .orderBy("supportTimeStamp", Query.Direction.DESCENDING)
                .limit(limit)
                .addSnapshotListener(listener);
    }
